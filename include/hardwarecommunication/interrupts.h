  ...
  namespace hardwarecommunication {
    ...
    class InterruptHandler {
      protected:
        ...
        batos::hardwarecommunication::InterruptManager* interruptManager;

        InterruptHandler(batos::common::uint8_t interruptNumber, batos::hardwarecommunication::InterruptManager* interruptManager);
        ~InterruptHandler();
    ...
    public:
      ...
      static batos::common::uint32_t handleInterrupt(batos::common::uint8_t interruptNumber, batos::common::uint32_t esp);
      batos::common::uint32_t DoHandleInterrupt(batos::common::uint8_t interruptNumber, batos::common::uint32_t esp);
