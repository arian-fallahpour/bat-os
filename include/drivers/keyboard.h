...
namespace batos {
    namespace drivers {
        ...
        class KeyboardDriver: public batos::hardwarecommunication::InterruptHandler, public batos::drivers::Driver {
            ...
            public:
                KeyboardDriver(batos::hardwarecommunication::InterruptManager* manager, batos::drivers::KeyboardEventHandler* handler);
                ~KeyboardDriver();
